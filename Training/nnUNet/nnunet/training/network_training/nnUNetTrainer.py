...
class nnUNetTrainer(NetworkTrainer):
    ...
    def load_dataset(self):
        ...
        self.dataset_test = load_dataset(self.folder_with_preprocessed_data)
        # self.dataset_test = load_dataset('/zhangzengmin/AMOTS/Training/nnUNet/dataset/nnUNet_preprocessed/Task003_Valid_Crop/ExperimentPlanner3DFabiansResUNet_v21_Organs_stage0')
        # self.dataset_test = load_dataset('/zhangzengmin/AMOTS/Training/nnUNet/dataset/nnUNet_preprocessed/Task003_Valid_Crop/ExperimentPlanner3DFabiansResUNet_v21_Tumor_stage0')
    ...
    def get_basic_generators(self):
        ...
        if self.threeD:
            ...
            dl_val = DataLoader3D(self.dataset_test, self.patch_size, self.patch_size, self.batch_size, False,
            ...
            dl_tr = DataLoader2D(self.dataset_tr, self.basic_generator_patch_size, self.patch_size, self.batch_size,
                                 oversample_foreground_percent=self.oversample_foreground_percent,
                                 pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
            dl_val = DataLoader2D(self.dataset_test, self.patch_size, self.patch_size, self.batch_size,
                                  oversample_foreground_percent=self.oversample_foreground_percent,
                                  pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
        return dl_tr, dl_val
